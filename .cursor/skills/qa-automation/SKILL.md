...
`scenario_draft.md`를 읽어 `outputs/test_plan.json` 생성. 5개 카테고리(basic_function, button_state, navigation, edge_case, accessibility). TC 번호, JSON 구조, 선택자 우선순위 등은 [SPEC.md](../../../SPEC.md) Key Conventions 참조.
