...
### Phase 1: 문서 분석
1. `ai-qa-automation/inputs/` 폴더에서 PPTX 파일 확인
2. PPTX 내용을 추출하여 분석
3. `ai-qa-automation/outputs/scenario_draft.md`로 테스트 시나리오 생성

### Phase 2: 테스트 설계  
1. `scenario_draft.md` 파일 읽기
2. 자동화 가능한 테스트 케이스로 변환
3. `ai-qa-automation/outputs/test_plan.json`으로 저장
...
### Phase 4: 리포트 생성
1. 테스트 결과 취합
2. `ai-qa-automation/outputs/REPORT.md` 파일 생성
